...
const PlacementTests=dynamic(()=>import('./PlacementTests').then(m=>m.PlacementTests),{ssr:false,loading:()=> <p>現在地テストを読み込み中…</p>});
const FoundationCourse=dynamic(()=>import('./FoundationCourse').then(m=>m.FoundationCourse),{ssr:false,loading:()=> <p>基礎課程を読み込み中…</p>});
const nav = [
