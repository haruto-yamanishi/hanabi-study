...
export const assessments: AssessmentItem[] = [
  ...
  {id:'a-trig-1',skillId:'m-trig',competency:'recall',format:'mcq',difficulty:1,prompt:'単位円上の点 (cosθ, sinθ) で cosθ が表すものは？',options:['x座標','y座標','半径','弧長'],answer:0,explanation:'cosθはx座標。',revision:1},
  {id:'a-vector-1',skillId:'m-vectors',competency:'calculate',format:'numeric',difficulty:2,prompt:'a=(1,2), b=(3,4) の内積 a·b を入力してください。',answer:'11',tolerance:0,explanation:'1×3+2×4=11。',revision:1},
  {id:'a-diff-1',skillId:'m-calc-diff',competency:'calculate',format:'mcq',difficulty:2,prompt:'f(x)=x² の導関数は？',options:['x','2x','x²/2','2'],answer:1,explanation:'べき乗則より2x。',revision:1},
  ...
  {id:'a-linear-1',skillId:'m-linear',competency:'recall',format:'mcq',difficulty:3,prompt:'回転行列Rの列ベクトルが互いに直交することを表す式は？',options:['RᵀR=I','R+R=I','R²=0','det(R)=0'],answer:0,explanation:'正規直交行列ではRᵀR=I。',revision:1},
  {id:'a-prob-1',skillId:'m-prob',competency:'calculate',format:'mcq',difficulty:2,prompt:'独立な事象A,Bについて P(A∩B) は？',options:['P(A)+P(B)','P(A)P(B)','P(A)/P(B)','1-P(A)'],answer:1,explanation:'独立なら積。',revision:1},

  // Physics
  {id:'a-kin-1',skillId:'p-kinematics',competency:'calculate',format:'numeric',difficulty:1,prompt:'静止から2 m/s²で3秒加速したときの速度[m/s]は？',answer:'6',tolerance:.01,explanation:'v=at=6 m/s。',revision:1},
  {id:'a-force-1',skillId:'p-forces',competency:'calculate',format:'numeric',difficulty:1,prompt:'2 kgの物体に6 Nの合力。加速度[m/s²]は？',answer:'3',tolerance:.01,explanation:'a=F/m=3。',revision:1},
  ...
  {id:'a-rotation-1',skillId:'p-rotation',competency:'calculate',format:'numeric',difficulty:2,prompt:'半径0.25 mの腕の先に40 N。軸まわりのトルク[N·m]は？',answer:'10',tolerance:.01,explanation:'τ=rF=10 N·m。',frcContext:'arm',revision:1},
  {id:'a-friction-1',skillId:'p-friction',competency:'transfer',format:'mcq',difficulty:3,prompt:'同じrobot massでwheelの最大tractionを増やす方法として最も直接的なのは？',options:['摩擦係数を高くする','encoder CPRを増やす','CAN IDを変える','PID I項を増やす'],answer:0,explanation:'最大静止摩擦は概ねμN。',frcContext:'drivetrain',revision:1},

  // Electronics
  {id:'a-ohm-1',skillId:'e-ohm',competency:'calculate',format:'numeric',difficulty:1,prompt:'10 Vを5 Ωにかけた電流[A]は？',answer:'2',tolerance:.01,explanation:'I=V/R=2 A。',revision:1},
  ...
  {id:'a-state-machine-1',skillId:'cs-state-machine',competency:'design',format:'mcq',difficulty:3,prompt:'Intakeの「待機→取り込み→保持→排出」を実装する構造として適切なのは？',options:['状態機械','巨大な1行式','毎loopでrandom選択','CAN IDだけで制御'],answer:0,explanation:'明確な状態と遷移条件に分ける。',revision:1},
  ...
  // Robotics
  {id:'a-coord-1',skillId:'r-coordinates',competency:'calculate',format:'mcq',difficulty:2,prompt:'2Dでベクトル(1,0)を+90°回転すると？',options:['(0,1)','(0,-1)','(1,1)','(-1,0)'],answer:0,explanation:'+90°でx軸はy軸へ。',revision:1},
  {id:'a-kinematics-1',skillId:'r-kinematics',competency:'recall',format:'mcq',difficulty:2,prompt:'順運動学が求める方向は？',options:['関節/ wheel状態→robot/手先運動','手先姿勢→関節角だけ','画像→class','電圧→電流だけ'],answer:0,explanation:'内部状態から外部motionを求める。',revision:1},
  ...
  {id:'a-algebra-2',skillId:'m-algebra',variantGroup:'vg-algebra-linear',competency:'calculate',format:'numeric',difficulty:1,prompt:'5(x + 2) = 35 を満たす x は？',answer:'5',tolerance:0,explanation:'x+2=7 → x=5。',revision:1},
  {id:'a-gear-2',skillId:'me-gears',variantGroup:'vg-gear-ratio',competency:'calculate',format:'numeric',difficulty:2,prompt:'18T gearが72T gearを駆動。理想減速比(出力/入力torque倍率)は？',answer:'4',tolerance:.01,explanation:'72/18=4。',frcContext:'gearbox review',revision:1},
